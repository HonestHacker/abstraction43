...
var cube_preview_script := preload("res://scripts/entities/player/pda/actions/spawn_cube.gd").new()
...
func _physics_process(delta):
	Preload.for_process($logic/settings, $logic/save, $logic/pause_menu)
	cube_preview_script.process_for_cube(get_tree(), self)
